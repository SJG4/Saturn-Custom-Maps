COURSE_ACTS(COURSE_BOB, _(" 1 GLOWSHIRE"),
...
COURSE_ACTS(COURSE_WF, _(" 2 MARIO'S HOUSE EXTERIOR"),
...
COURSE_ACTS(COURSE_CCM, _(" 4 SNOWY TOWN"),
...
COURSE_ACTS(COURSE_LLL, _(" 7 BARN"),
...
COURSE_ACTS(COURSE_TTM, _("12 CITY PLAZA"),
...
COURSE_ACTS(COURSE_THI, _("13 CHURCHESTER"),
...
SECRET_STAR(COURSE_PSS, _("   MARIO'S HOUSE INTERIOR"))
SECRET_STAR(COURSE_COTMC, _("   CAVERN OF THE METAL CAP"))
SECRET_STAR(COURSE_TOTWC, _("   COLLEBELLO TOWN"))
SECRET_STAR(COURSE_VCUTM, _("   VANISH CAP UNDER THE MOAT"))
SECRET_STAR(COURSE_WMOTR, _("   MACHINIMA CASTLE"))
SECRET_STAR(COURSE_SA, _("   CHROMA KEY STAGE"))
