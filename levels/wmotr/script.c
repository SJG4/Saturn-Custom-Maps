...
const LevelScript level_wmotr_entry[] = {
	...
	AREA(1, wmotr_area_1),
		...
		OBJECT(MODEL_CASTLE_CASTLE_DOOR, 2074, -473, 167, 0, -90, 0, 0x00000000, bhvDoor),
		OBJECT(MODEL_CASTLE_CASTLE_DOOR, -2046, -472, 176, 0, 90, 0, 0x00000000, bhvDoor),
		...
		OBJECT(MODEL_CASTLE_CLOCK_HOUR_HAND, 19, 482, -1110, 0, 0, 0, 0x00000000, bhvClockHourHand),
		OBJECT(MODEL_CASTLE_CASTLE_DOOR, 1775, -171, -1281, 0, 0, 0, 0x00000000, bhvDoor),
		OBJECT(MODEL_CASTLE_CASTLE_DOOR, -1745, -171, -1257, 0, 180, 0, 0x00000000, bhvDoor),
		OBJECT(MODEL_MAD_PIANO, -2817, -171, -4248, 0, 35, 0, 0x00000000, bhvMadPiano),
		OBJECT(MODEL_CASTLE_CASTLE_DOOR, -51, -674, 2541, 0, 0, 0, 0x00000000, bhvDoor),
		OBJECT(MODEL_CASTLE_CASTLE_DOOR, 106, -674, 2541, 0, 180, 0, 0x00000000, bhvDoor),
		OBJECT(MODEL_CASTLE_CLOCK_MINUTE_HAND, 24, 480, -1122, 0, 0, 0, 0x00000000, bhvClockMinuteHand),
		OBJECT(MODEL_CASTLE_CASTLE_DOOR, -56, -171, -1270, 0, 0, 0, 0x00000000, bhvDoor),
		OBJECT(MODEL_CASTLE_CASTLE_DOOR, 101, -171, -1270, 0, 180, 0, 0x00000000, bhvDoor),
