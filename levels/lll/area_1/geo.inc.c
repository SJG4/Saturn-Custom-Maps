...
const GeoLayout lll_area_1_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, 199, 0, -267, 90, 0, 0, lll_dl_019_12B7A8E2_c_bmp_mesh_layer_1),
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, 199, 0, -267, 90, 0, 0, lll_dl_023_44345259_c_bmp_mesh_layer_1),
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, 199, 0, -267, 90, 0, 0, lll_dl_025_5AB0F974_c_bmp_mesh_layer_1),
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, 199, 0, -267, 90, 0, 0, lll_dl_077_795C48E8_c_bmp_mesh_layer_1),
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, 199, 0, -267, 90, 0, 0, lll_dl_103_5B53EF73_c_bmp_mesh_layer_1),
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, 199, 0, -267, 90, 0, 0, lll_dl_106_22F1F428_c_bmp_mesh_layer_1),
...
const GeoLayout lll_area_1[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_OPEN_NODE(),
			...
			GEO_CLOSE_NODE(),
		GEO_CLOSE_NODE(),
		GEO_LEVEL_DISPLAY_LIST(LAYER_OPAQUE, lll_dl_material_revert_render_settings),
	GEO_CLOSE_NODE(),
	GEO_END(),
};
